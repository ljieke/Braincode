...
from braincode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from braincode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from braincode.agents.trace import TraceManager, TraceNode
from braincode.agents.task_manager import BackgroundTask, TaskManager
from braincode.agents.notification import format_task_notification, inject_task_notifications
from braincode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".braincode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from braincode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from braincode.tools.agent_tool import AgentToolParams
