...
from braincode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from braincode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from braincode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
