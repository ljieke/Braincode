...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from braincode.agents.fork import ForkError, build_forked_messages
        from braincode.agents.parser import AgentDef
        from braincode.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from braincode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from braincode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from braincode.agents.fork import ForkError, build_forked_messages
        from braincode.agents.parser import AgentDef
        from braincode.agents.tool_filter import build_teammate_tools
        from braincode.agent import Agent as AgentClass
        from braincode.conversation import ConversationManager
        from braincode.permissions import (
            DangerousCommandDetector,
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from braincode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from braincode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from braincode.worktree.integration import (
