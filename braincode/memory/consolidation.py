...
from braincode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".braincode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".braincode", "memory")
    ...
    async def _do_consolidation(
        ...
        from braincode.tools.bash import BashTool
        from braincode.tools.edit_file import EditFileTool
        from braincode.tools.glob import GlobTool
        from braincode.tools.grep import GrepTool
        from braincode.tools.read_file import ReadFileTool
        from braincode.tools.write_file import WriteFileTool

        transcript_dir = os.path.join(self._work_dir, ".braincode", "sessions")
