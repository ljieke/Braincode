...
from braincode.commands import (
    CommandContext,
    CommandRegistry,
    complete,
    parse_command,
...
from braincode.agents.notification import inject_task_notifications
from braincode.commands.handlers.tasks import create_tasks_command
from braincode.skills.executor import SkillExecutor
from braincode.skills.loader import SkillLoader
from braincode.commands.handlers.skill_register import register_skill_commands
...
from braincode.worktree.cleanup import start_stale_cleanup_task
from braincode.worktree.manager import WorktreeManager
from braincode.commands.handlers.worktree import create_worktree_command
from braincode.teammate_tree import TeammateTree
...
_SKIP_DIRS = {".git", "node_modules", ".venv", "__pycache__", ".braincode", "build", ".gradle"}
...
class ChatInput(TextArea):
    ...
    def load_history(self, work_dir: str) -> None:
        self._history_file = Path(work_dir) / ".braincode" / "history"
...
class BraincodeApp(App):
    ...
    def on_mount(self) -> None:
        self.register_theme(_BRAINCODE_THEME)
        self.theme = "braincode"
        if len(self.providers) == 1:
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        from braincode.filehistory import FileHistory
        ...
        from braincode.tools.enter_worktree import EnterWorktreeTool
        from braincode.tools.exit_worktree import ExitWorktreeTool
        ...
        from braincode.commands.handlers.trace import create_trace_command
    ...
    async def _show_plan_approval(self) -> None:
        from braincode.plan_dialog import InlinePlanWidget
    ...
    def on_inline_plan_widget_responded(
        ...
        from braincode.plan_dialog import InlinePlanWidget, PlanChoice
        from braincode.prompts import build_plan_mode_exit_reminder
    ...
    async def _handle_askuser(self, event: AskUserEvent) -> None:
        from braincode.askuser_dialog import InlineAskUserWidget
    ...
    async def _handle_permission_request(self, request: PermissionRequest) -> None:
        from braincode.permission_dialog import InlinePermissionWidget
