...
def build_teammate_tools(
    ...
    from braincode.tools.send_message import SendMessageTool
    from braincode.tools.task_create import TaskCreateTool
    from braincode.tools.task_get import TaskGetTool
    from braincode.tools.task_list import TaskListTool
    from braincode.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from braincode.tools.agent_tool import FORK_QUERY_SOURCE
